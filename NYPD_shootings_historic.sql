/* This dataset lists every shooting incident that occurred in New York City from January 1, 2006 through 
December 31, 2020. Included in the dataset is such information as the date and time of each shooting as well as 
demographic information about the victims and perpetrators. The data is manually extracted on a quarterly basis and 
reviewed by the Office of Management Analysis and Planning before being posted on the NYPD's website. The original 
dataset can be found at https://data.cityofnewyork.us/Public-Safety/NYPD-Shooting-Incident-Data-Historic-/833y-fsy8. */
